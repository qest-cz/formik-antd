...
export const TimePicker = (_a) => {
    ...
    return (React.createElement(Field, { name: name, validate: validate, fast: fast }, ({ field: { value }, form: { setFieldValue, setFieldTouched }, }) => (React.createElement($TimePicker
    //@ts-ignore
    , Object.assign({ 
        //@ts-ignore
        value: value ? moment(value) : undefined, onChange: (time, timeString) => {
